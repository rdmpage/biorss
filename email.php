...
$filename = 'new  intitle_"new species" - new results.eml';
$filename = '"n. sp." OR "new species" OR "n. gen." OR "sp. nov ... - new results.eml';
...
// where shall we save this?

$cache_dir = $config['cache'];
$filename = $cache_dir . '/google.json';
